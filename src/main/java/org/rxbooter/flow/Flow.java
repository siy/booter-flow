...
import org.rxbooter.flow.impl.PipelineBuilder;
...
public class Flow<O extends Tuple, I extends Tuple> {
    ...
    public PipelineBuilder<O, I> asPipeline(Supplier<I> input, Consumer<O> output) {
        return new PipelineBuilder<>(this, input, output);
    }
    ...
    public static<T1> FlowBuilder1<Tuple1<T1>, T1> take(TypeHolder<T1> param1) {
        return new FlowBuilder1<>(null);
    }

    public static<T1, T2> FlowBuilder2<Tuple2<T1, T2>, T1, T2> take(TypeHolder<T1> param1, TypeHolder<T2> param2) {
        return new FlowBuilder2<>(null);
    }

    public static<T1, T2, T3> FlowBuilder3<Tuple3<T1, T2, T3>, T1, T2, T3> take(TypeHolder<T1> param1, TypeHolder<T2> param2, TypeHolder<T3> param3) {
        return new FlowBuilder3<>(null);
    }

    public static<T1, T2, T3, T4> FlowBuilder4<Tuple4<T1, T2, T3, T4>, T1, T2, T3, T4> take(TypeHolder<T1> param1, TypeHolder<T2> param2, TypeHolder<T3> param3, TypeHolder<T4> param4) {
        return new FlowBuilder4<>(null);
    }

    public static<T1, T2, T3, T4, T5> FlowBuilder5<Tuple5<T1, T2, T3, T4, T5>, T1, T2, T3, T4, T5> take(TypeHolder<T1> param1, TypeHolder<T2> param2, TypeHolder<T3> param3, TypeHolder<T4> param4, TypeHolder<T5> param5) {
        return new FlowBuilder5<>(null);
    }

    public static<T1, T2, T3, T4, T5, T6> FlowBuilder6<Tuple6<T1, T2, T3, T4, T5, T6>, T1, T2, T3, T4, T5, T6> take(TypeHolder<T1> param1, TypeHolder<T2> param2, TypeHolder<T3> param3, TypeHolder<T4> param4, TypeHolder<T5> param5, TypeHolder<T6> param6) {
        return new FlowBuilder6<>(null);
    }

    public static<T1, T2, T3, T4, T5, T6, T7> FlowBuilder7<Tuple7<T1, T2, T3, T4, T5, T6, T7>, T1, T2, T3, T4, T5, T6, T7> take(TypeHolder<T1> param1, TypeHolder<T2> param2, TypeHolder<T3> param3, TypeHolder<T4> param4, TypeHolder<T5> param5, TypeHolder<T6> param6, TypeHolder<T7> param7) {
        return new FlowBuilder7<>(null);
    }

    public static<T1, T2, T3, T4, T5, T6, T7, T8> FlowBuilder8<Tuple8<T1, T2, T3, T4, T5, T6, T7, T8>, T1, T2, T3, T4, T5, T6, T7, T8> take(TypeHolder<T1> param1, TypeHolder<T2> param2, TypeHolder<T3> param3, TypeHolder<T4> param4, TypeHolder<T5> param5, TypeHolder<T6> param6, TypeHolder<T7> param7, TypeHolder<T8> param8) {
        return new FlowBuilder8<>(null);
    }

    public static<T1, T2, T3, T4, T5, T6, T7, T8, T9> FlowBuilder9<Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9>, T1, T2, T3, T4, T5, T6, T7, T8, T9> take(TypeHolder<T1> param1, TypeHolder<T2> param2, TypeHolder<T3> param3, TypeHolder<T4> param4, TypeHolder<T5> param5, TypeHolder<T6> param6, TypeHolder<T7> param7, TypeHolder<T8> param8, TypeHolder<T9> param9) {
        return new FlowBuilder9<>(null);
    }
}
