...
public interface Reactor {
     ...
     * @return Instance of {@link Promise} which receives notifications on provided {@link Supplier}
     * instance execution. If {@link Supplier} is executed successfully then returned {@link Promise}
     * instance will receive value returned by supplier. If {@link Supplier} throws an exception,
     * then it is rethrown once {@link Promise#await()} is invoked.
     */
    ...
    /**
     * Await result of execution of provided supplier. Returned instance of {@link Tuple1} holds
     * value returned by {@link Supplier} if execution of provided supplier was successful. If
     * {@link Supplier} throws an exception then exception is rethrown.
     *
     * @param param1
    ...
    /**
     * Await results of execution of provided suppliers. Returned instance of {@link Tuple2} holds
     * values returned by provided {@link Supplier}'s if execution of them was successful. If
     * any {@link Supplier} throws an exception then exception is rethrown.
     *
     * @param param1
    ...
    /**
     * Await results of execution of provided suppliers. Returned instance of {@link Tuple3} holds
     * values returned by provided {@link Supplier}'s if execution of them was successful. If
     * any {@link Supplier} throws an exception then exception is rethrown.
     *
     * @param param1
    ...
    /**
     * Await results of execution of provided suppliers. Returned instance of {@link Tuple4} holds
     * values returned by provided {@link Supplier}'s if execution of them was successful. If
     * any {@link Supplier} throws an exception then exception is rethrown.
     *
     * @param param1
    ...
    /**
     * Await results of execution of provided suppliers. Returned instance of {@link Tuple5} holds
     * values returned by provided {@link Supplier}'s if execution of them was successful. If
     * any {@link Supplier} throws an exception then exception is rethrown.
     *
     * @param param1
    ...
    /**
     * Await results of execution of provided suppliers. Returned instance of {@link Tuple6} holds
     * values returned by provided {@link Supplier}'s if execution of them was successful. If
     * any {@link Supplier} throws an exception then exception is rethrown.
     *
     * @param param1
    ...
    /**
     * Await results of execution of provided suppliers. Returned instance of {@link Tuple7} holds
     * values returned by provided {@link Supplier}'s if execution of them was successful. If
     * any {@link Supplier} throws an exception then exception is rethrown.
     *
     * @param param1
    ...
    /**
     * Await results of execution of provided suppliers. Returned instance of {@link Tuple8} holds
     * values returned by provided {@link Supplier}'s if execution of them was successful. If
     * any {@link Supplier} throws an exception then exception is rethrown.
     *
     * @param param1
    ...
    /**
     * Await results of execution of provided suppliers. Returned instance of {@link Tuple9} holds
     * values returned by provided {@link Supplier}'s if execution of them was successful. If
     * any {@link Supplier} throws an exception then exception is rethrown.
     *
     * @param param1
